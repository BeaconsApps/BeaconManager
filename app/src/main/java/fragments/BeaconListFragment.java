...
import app.tohubee.beaconmanager.R;
...
public class BeaconListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View containerView = inflater.inflate(R.layout.fragment_beacon_list, container, false);
        beaconList = (RecyclerView) containerView.findViewById(R.id.beacon_item_list);
